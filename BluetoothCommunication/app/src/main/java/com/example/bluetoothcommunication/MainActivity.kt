...
import com.example.bluetoothcommunication.DeviceListAdapter
import com.example.bluetoothcommunication.R
...
//case1: bonded already
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val btnONOFF =
            findViewById<View>(R.id.btnONOFF) as Button
        btnEnableDisable_Discoverable =
            findViewById<View>(R.id.btnDiscoverable_on_off) as Button
        lvNewDevices =
            findViewById<View>(R.id.lvNewDevices) as ListView
        mBTDevices = ArrayList()
        btnStartConnection =
            findViewById<View>(R.id.btnStartConnection) as Button
        ...
        btnONOFF.setOnClickListener {
            Log.d(
                TAG,
                "onClick: enabling/disabling bluetooth."
            )
            enableDisableBT()
        }
        btnStartConnection!!.setOnClickListener { startConnection() }
        btnSend!!.setOnClickListener {
            val bytes = etSend!!.text.toString()
...
//***remember the conncction will fail and app will crash if you haven't paired first
    ...
    fun enableDisableBT() {
        if (mBluetoothAdapter == null) {
            Log.d(
                TAG,
                "enableDisableBT: Does not have BT capabilities."
            )
        }
